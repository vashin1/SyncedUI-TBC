...
Cartographer.revision = tonumber(string.sub("$Revision: 2255 $", 12, -3))
Cartographer.version = "r" .. Cartographer.revision
Cartographer.date = string.sub("$Date: 2008-10-15 18:20:26 +0000 (Wed, 15 Oct 2008) $", 8, 17)
...
--Ananhaid checkpoint.($Date: 2008-10-15 18:20:26 +0000 (Wed, 15 Oct 2008) $)
